...
class WanTrainingModule(DiffusionTrainingModule):
    ...
    def forward_preprocess(self, data):
        ...
        for unit in self.pipe.units:
            ...
            # WanVideoUnit_ShapeChecker             480 832 49
            # WanVideoUnit_NoiseInitializer         torch.Size([1, 16, 13, 60, 104])
            # WanVideoUnit_PromptEmbedder           # 文本 （1，512， 4096）
            # WanVideoUnit_S2V                      # 不进入
            # WanVideoUnit_InputVideoEmbedder       torch.Size([1, 16, 13, 60, 104]) torch.Size([1, 16, 13, 60, 104])
